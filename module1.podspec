#
# Be sure to run `pod lib lint module2.podspec' to ensure this is a
...
This is module1 to test integration in the main app.
  ...
  s.source           = { :git => 'https://github.com/yuvirajsinh/module1.git', :tag => s.version.to_s }
